...
public class UserService {
	...
	public String addUser(UserDAO userDAO){
		try {
			...
			um.setEmail(userDAO.getEmail());
			um.setPassword(userDAO.getPassword());
			um.setUserName(userDAO.getUserName());
			um.setMobileNumber(userDAO.getMobileNumber());
			um.setUserRole(userDAO.getUserRole());
